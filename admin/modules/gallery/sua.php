...
<div class="widget-box">
    ...
    <div class="widget-content nopadding">
        <form class="form-horizontal" action="modules/gallery/xuly.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data" >
            <h5>&nbsp;</h5>
            ...
            <div class="control-group">
                <div class="controls">
                    <input type="submit" name="suasp" value="Lưu lại" class="btn btn-default">
